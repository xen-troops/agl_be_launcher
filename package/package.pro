...
DISTFILES = icon.png config.xml

!equals($$_PRO_FILE_PWD_, $$OUT_PWD) {
    copy_icon.target = $$OUT_PWD/root/icon.png
    copy_icon.depends = $$_PRO_FILE_PWD_/icon.png
...
wgt.target = package
wgt.commands = wgtpkg-pack -f -o agl_surface_switcher.wgt root
